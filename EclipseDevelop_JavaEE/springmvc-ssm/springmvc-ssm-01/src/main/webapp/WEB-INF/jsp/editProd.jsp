...
<body>
	<div class="container">
		<form class="form-horizontal" role="form" action="${ctx }/prod/editProdSubmit.do" method="post" accept-charset="utf-8">
            ...
            <div class="form-group">
                ...
                <div class="input-group date form_datetime col-md-5" data-date="1979-09-16 00:00" data-date-format="yyyy-mm-dd HH:ii" data-link-field="shelfTime">
                    <input class="form-control" size="16" height="25px" type="text"  name="shelfTime" value="<fmt:formatDate value="${product.shelfTime }" pattern="yyyy-MM-dd HH:mm"/>" readonly>
