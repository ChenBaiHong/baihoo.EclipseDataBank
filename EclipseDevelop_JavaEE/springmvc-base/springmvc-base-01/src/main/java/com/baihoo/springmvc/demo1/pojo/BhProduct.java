package com.baihoo.springmvc.demo1.pojo;
...
public class BhProduct implements Serializable{
	...
	public BhProduct(String id , String name, Double price, Date createTime) {
		super();
		this.id = id;
		this.name = name;
		this.price = price;
