 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://server.publish.ws.baihoo.com/", wsdlLocation = "http://127.0.0.1:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://server.publish.ws.baihoo.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://server.publish.ws.baihoo.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.publish.ws.baihoo.com/", "HelloServicePort"), HelloService.class, features);
    }
