 ...
 * 
 */
@WebServiceClient(name = "PersonServiceService", targetNamespace = "http://server2.publish.ws.baihoo.com/", wsdlLocation = "http://127.0.0.1:8889/person?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICESERVICE_QNAME = new QName("http://server2.publish.ws.baihoo.com/", "PersonServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8889/person?wsdl");
    ...
    public PersonService getPersonServicePort() {
        return super.getPort(new QName("http://server2.publish.ws.baihoo.com/", "PersonServicePort"), PersonService.class);
    }
    ...
    public PersonService getPersonServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server2.publish.ws.baihoo.com/", "PersonServicePort"), PersonService.class, features);
    }
