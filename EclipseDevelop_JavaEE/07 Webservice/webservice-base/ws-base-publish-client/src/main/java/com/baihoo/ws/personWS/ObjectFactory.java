 ...
 * generated in the com.baihoo.ws.personWS package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersonAll_QNAME = new QName("http://server2.publish.ws.baihoo.com/", "getPersonAll");
    private final static QName _AddPersonResponse_QNAME = new QName("http://server2.publish.ws.baihoo.com/", "addPersonResponse");
    private final static QName _AddPerson_QNAME = new QName("http://server2.publish.ws.baihoo.com/", "addPerson");
    private final static QName _GetPersonAllResponse_QNAME = new QName("http://server2.publish.ws.baihoo.com/", "getPersonAllResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.baihoo.ws.personWS
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server2.publish.ws.baihoo.com/", name = "getPersonAll")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server2.publish.ws.baihoo.com/", name = "addPersonResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server2.publish.ws.baihoo.com/", name = "addPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server2.publish.ws.baihoo.com/", name = "getPersonAllResponse")
