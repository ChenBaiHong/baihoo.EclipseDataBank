 ...
 * 2018-07-18T11:24:25.398+08:00
 * Generated source version: 3.2.0
 * 
 */
@WebServiceClient(name = "UserServiceService", 
                  wsdlLocation = "http://localhost:8080/ws-cxf-web-server/service/userWs?wsdl",
                  targetNamespace = "http://server.cxf.web.baihoo.com/") 
public class UserServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.cxf.web.baihoo.com/", "UserServiceService");
    public final static QName UserServicePort = new QName("http://server.cxf.web.baihoo.com/", "UserServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/ws-cxf-web-server/service/userWs?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/ws-cxf-web-server/service/userWs?wsdl");
        }
        WSDL_LOCATION = url;
    }
