...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
  ...
  String lhgdialogTheme = SysThemesUtil.getLhgdialogTheme(sysTheme);
      ...
      out.write("              </div>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"center\"><h4 class=\"blue\" id=\"id-company-text\">&copy; JEECG版权所有 v_3.7.1</h4></div>\n");
  ...
  private boolean _jspx_meth_t_005fdictSelect_005f0(PageContext _jspx_page_context)
    ...
    // /webpage/login/login.jsp(117,22) name = id type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdictSelect_005f0.setId("langCode");
    // /webpage/login/login.jsp(117,22) name = field type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdictSelect_005f0.setField("langCode");
    // /webpage/login/login.jsp(117,22) name = typeGroupCode type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdictSelect_005f0.setTypeGroupCode("lang");
    // /webpage/login/login.jsp(117,22) name = hasLabel type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdictSelect_005f0.setHasLabel(false);
    // /webpage/login/login.jsp(117,22) name = extendJson type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_t_005fdictSelect_005f0.setExtendJson("{style:'padding:2px; width:80px;'}");
    // /webpage/login/login.jsp(117,22) name = defaultVal type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
