...
<div class="header-top-w3layouts">
    <div class="container">
        <div class="col-md-6 logo-w3">
            <a href="#"><img src="${pageContext.request.contextPath}/foregroundPlug/images/logo2.png" alt=" " /><h1>时尚俱乐部<span></span></h1></a>
        </div>
                                ...
                                <ul class="dropdown-menu multi">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 w3l">
                                            <a href="javascript:;"><img src="${pageContext.request.contextPath}/foregroundPlug/images/menu${status.count}.jpg" class="img-responsive" alt=""></a>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </ul>
			...
			<div class="form-w3agile">
				...
				<form action="#" method="post">
					<div class="key">
						...
						<input  type="text" name="Email" required="" placeholder="电子邮箱/用户名/手机号" autocomplete="off">
						<div class="clearfix"></div>
					</div>
					<div class="key">
