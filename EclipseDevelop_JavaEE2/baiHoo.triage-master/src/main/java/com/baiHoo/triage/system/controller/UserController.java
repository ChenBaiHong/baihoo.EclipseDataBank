package com.baiHoo.triage.system.controller;
...
import com.baiHoo.triage.common.controller.BaseController;
import com.baiHoo.triage.common.persistence.Page;
import com.baiHoo.triage.common.persistence.PropertyFilter;
import com.baiHoo.triage.system.entity.User;
import com.baiHoo.triage.system.service.UserRoleService;
import com.baiHoo.triage.system.service.UserService;
...
public class UserController extends BaseController {
	...
	@ResponseBody
	public String create(@Valid User user,Integer deptId, Model model) {
	...
	@ResponseBody
	public String update(@Valid @ModelAttribute @RequestBody User user,Integer deptId,Model model) {
		Dept dept = new Dept(deptId);
		user.setDept(dept);
