...
import com.baiHoo.core.util.ApplicationContextUtil;
import com.baiHoo.core.util.ResourceUtil;
import com.baiHoo.core.util.StringUtil;
import com.baiHoo.core.util.oConvertUtils;
import com.baiHoo.tag.vo.easyui.ColumnValue;
import com.baiHoo.tag.vo.easyui.DataGridColumn;
import com.baiHoo.tag.vo.easyui.DataGridUrl;
import com.baiHoo.tag.vo.easyui.OptTypeDirection;
...
public class DataGridTag extends TagSupport {
	...
	protected String searchFields = "";// 查询字段  Author:baiHoo  Date: for：添加对区间查询的支持
	...
	public String getNoAuthOperButton(){
		...
		com.baiHoo.core.util.LogUtil.info("----getNoAuthOperButton-------"+sb.toString());
		return sb.toString(); 
	}
