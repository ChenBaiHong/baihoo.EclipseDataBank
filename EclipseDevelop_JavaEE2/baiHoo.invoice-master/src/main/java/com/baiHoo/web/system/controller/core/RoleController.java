...
import com.baiHoo.core.util.ExceptionUtil;
import com.baiHoo.core.util.NumberComparator;
...
public class RoleController extends BaseController {
	...
	public void roleGrid( TSRole role,HttpServletRequest request,
		...
		com.baiHoo.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, role);
		cq.add();
