package com.baiHoo.core.extend.template;
    ...
    public String transInfixToPosfix(String in)
    {
        ...
        for(int i=0;i<cin.length;i++)
        {
            ...
            case ')':
                ...
                if(!meetClose)
                {
                	com.baiHoo.core.util.LogUtil.info(in);
            ...
            default:
                ...
                try {
						...
						e.printStackTrace();
						com.baiHoo.core.util.LogUtil.info("cal数字生成错误！！");
					}
...
//        org.jeecgframework.core.util.LogUtil.info("value is:"+calc.calc());
       ...
       com.baiHoo.core.util.LogUtil.info(calc.transInfixToPosfix("1.3E7+0.5"));   
       com.baiHoo.core.util.LogUtil.info("value is:"+calc.calc());
        Double dd=Double.parseDouble("1.35378957E7");
        
        com.baiHoo.core.util.LogUtil.info(Caculator.getDtoI(dd));
        
        com.baiHoo.core.util.LogUtil.info(dd);
