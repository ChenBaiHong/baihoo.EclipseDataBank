package com.baiHoo.core.common.dao.impl;
...
import com.baiHoo.core.annotation.JeecgEntityTitle;
import com.baiHoo.core.common.dao.IGenericBaseCommonDao;
import com.baiHoo.core.common.dao.jdbc.JdbcDao;
import com.baiHoo.core.common.exception.BusinessException;
import com.baiHoo.core.common.hibernate.qbc.CriteriaQuery;
import com.baiHoo.core.common.hibernate.qbc.DetachedCriteriaUtil;
import com.baiHoo.core.common.hibernate.qbc.HqlQuery;
import com.baiHoo.core.common.hibernate.qbc.PageList;
import com.baiHoo.core.common.hibernate.qbc.PagerUtil;
import com.baiHoo.core.common.model.common.DBTable;
import com.baiHoo.core.common.model.json.DataGridReturn;
import com.baiHoo.core.util.MyBeanUtils;
import com.baiHoo.core.util.ToEntityUtil;
import com.baiHoo.core.util.oConvertUtils;
import com.baiHoo.tag.vo.datatable.DataTableReturn;

/**
 * 
 *<p>Title: GenericBaseCommonDao</p>
 *<p>Description: 
 *
 * 类描述： DAO层泛型基类
 *
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	...
	private <T> void getProperty(Class entityName) {
		...
		for (int i = 0; i < str.length; i++) {
			...
			com.baiHoo.core.util.LogUtil.info(property + "---&gt;" + type);
		}
	}
