...
import com.baiHoo.core.def.ConstantsDefs;
...
public class JeecgSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		com.baiHoo.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		com.baiHoo.core.util.LogUtil.info(sqlurl);
...
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		com.baiHoo.core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		...
		com.baiHoo.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
