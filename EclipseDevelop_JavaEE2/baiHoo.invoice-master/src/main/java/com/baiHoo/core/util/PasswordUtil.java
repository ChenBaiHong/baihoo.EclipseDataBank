...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		com.baiHoo.core.util.LogUtil.info("明文:" + str);
		com.baiHoo.core.util.LogUtil.info("密码:" + password);

		try {
			byte[] salt = PasswordUtil.getStaticSalt();
			String ciphertext = PasswordUtil.encrypt(str, password, salt);
			com.baiHoo.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			com.baiHoo.core.util.LogUtil.info("明文:" + plaintext);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
