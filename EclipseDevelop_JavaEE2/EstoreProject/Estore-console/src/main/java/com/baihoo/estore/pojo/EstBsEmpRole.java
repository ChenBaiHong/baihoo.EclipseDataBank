 ...
 */
@Entity
@Table(name="est_bs_emp_role")
public class EstBsEmpRole implements Serializable{

	/**
	 *
	 * @param est_bs_emp_role_id		数据唯一识别ID
	...
	@Id
	@GeneratedValue
	@Column(name = "est_bs_emp_role_id")
	private Integer estBsEmpRoleId;	//数据唯一识别ID
	@Column(name = "emp_id")
	...
	public void setEstBsEmpRoleId(Integer estBsEmpRoleId){
		this.estBsEmpRoleId=estBsEmpRoleId;
	}
	public Integer getEstBsEmpRoleId(){
