 ...
 * 
 * @ClassName: WebUtils
 * @Description: web的上载文件与下载文件工具
 * @author: Administrator
 * @date: 2018年7月28日 下午12:01:12
 */
public class WebUtils {
	...
	public <T>T servletFileUploadToBean(HttpServletRequest request , Class<T> beanClass , String[] limitFileSuffixTypes) throws Exception{
		T bean;
		try {
