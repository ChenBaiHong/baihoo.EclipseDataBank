...
<head>
    ...
    <!--开始引入css stylesheet-->
    <!-- BOOTSTRAP CSS -->
    <link href="${ctx}/backgroundPlug/css/bootstrap.min.css" rel="stylesheet"/>
    <!-- 特色风格的字体 图标 CSS样式 -->
    <link href="${ctx}/backgroundPlug/assets/font-awesome/css/font-awesome.css"rel="stylesheet"/>
    <!-- 基本主题的 CSS 样式 -->
    <link href="${ctx}/backgroundPlug/css/style.css"rel="stylesheet"/>
    <!--结束引入css stylesheet-->
</head>
<body>
<!--开始-->
<section id="container">
                ...
                <li class="dropdown" id="header_inbox_bar">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li><a href="#"> <span class="photo">
                            <img alt="avatar" src="${ctx}/backgroundPlug/img/avatar-mini.jpg">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li>
                            <a href="${ctx}/WEB-INF/backstage/admin/adminProfile.jsp" target="main">
    ...
    <aside>
        <div id="sidebar" class="nav-collapse">
            <ul class="sidebar-menu" id="nav-accordion"><!--accordion:手风琴-->
                <li>
                    <a href="${ctx}/console/defaultMain.do" class="active" target="main">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li>
                                    <a href="${ctx }/rest/estBsEmp/empList/${empCustom.bsEmpDto.estBsEmpId}" 
                                    	id="" target="main"><!-- ergodicAdmin -->
                                        查看管理员
                                    </a>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><%--${ctx}/BackstageLogonServlet?method=allocationPrivilege--%>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="${ctx}/OrdersServlet?method=waitHandlerOrder" target="main">
                                待处理订单
                            </a>
                        </li>
                        <li>
                            <a href="${ctx}/OrdersServlet?method=alreadyHandlerOrder" target="main">
                                已发货订单
                            </a>
                        </li>
                    </ul>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="${ctx}/UserServlet?method=colonySendEmail" target="main">
                                客户群发邮件
                            </a>
                        </li>
                        <li>
                            <a href="${ctx}/UserServlet?method=searchUserEmail" target="main">
                                搜索客户发送邮件
                            </a>
                        </li>
                    </ul>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li>
                            <a href="${ctx}/DataBackupServlet?method=backupData" target="main">
                                备份数据
                            </a>
                        </li>
                        <li>
                            <a href="${ctx}/DataBackupServlet?recoverData" target="main">
                                数据恢复
                            </a>
                        </li>
                    </ul>
    ...
    <section id="main-content">
        <iframe src="${ctx}/console/defaultMain.do" name="main"  width="100%" height="100%"></iframe>
    </section>
...
<script src="${ctx}/backgroundPlug/js/jquery-3.1.1.min.js" ></script><!-- BASIC JQUERY 1.8.3 LIB. JS -->
<script src="${ctx}/backgroundPlug/js/bootstrap.min.js" ></script><!-- BOOTSTRAP JS -->
<script src="${ctx}/backgroundPlug/js/jquery.dcjqaccordion.2.7.js"></script><!-- ACCORDIN JS -->
<script src="${ctx}/backgroundPlug/js/respond.min.js" ></script><!-- RESPOND JS -->
<script src="${ctx}/backgroundPlug/js/common-scripts.js"></script><!-- BASIC COMMON JS -->
<script type="text/javascript">
    $(function(){
       ...
       var timer = setInterval(intervalTime, 1500);
        ...
        $("#allocationPrivilege").click(function(){
            var url = "${ctx}/PrivilegeServlet.servlet";
            ...
            $.post(url , args , function(data){
                ...
                if("no"==various){
                    ...
                    <%--"${ctx}/BackstageLogonServlet?method=allocationPrivilege"--%>
                    window.location.target="main";
                    main.location.href="${ctx}/BackstageLogonServlet.servlet?method=allocationPrivilege";
                }else if("error"==various){
                    window.location.href="${ctx}/500.jsp";
        ...
        $("#ergodicRole").click(function(){
            var url = "${ctx}/RoleServlet.servlet";
        ...
        $("#allocationRole").click(function(){
            //${ctx}/RoleServlet?method=addRole
            var url = "${ctx}/RoleServlet.servlet";
        ...
        $("#addictionAdmin").click(function(){
            //${ctx}/AdminServlet
            var url = "${ctx}/AdminServlet.servlet";
    ...
    function logonQuit(){
        ...
        if(result==true){
            top.location.href="${ctx}/BackstageLogonServlet.servlet?method=adminLogon";
        }
    }
    //knob:旋纽；按钮；门把，拉手
    $(".knob").knob();
