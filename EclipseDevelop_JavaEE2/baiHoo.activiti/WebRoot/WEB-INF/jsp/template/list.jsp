...
.widget-body {
    ...
    <script type="text/javascript">
   		function showMsgDialog(uuid){
   			top.$("button.md-trigger16").trigger("click");
   			top.$("#hide-val").val("template_delete?tm.uuid="+uuid);
   			top.$("#modal-16").find(".dialog-content").find("h3").html("是否删除当前表单模板？"); 
   		}
    </script>
  </head>
  <body>
  	<hr>
    <div class="header">
		<a class="link title-ani"  data-letters="表单模板管理">表单模板管理</a>
        <br>
    </div>
    <hr>
    <div id="wrap">
    <div class="container-fluid">
		...
		<div class="main_container">
          <div class="row-fluid">
            <div class="widget widget-padding span12">
              ...
              <s:form action="template_list.action" method="post">
		                    ...
		                    <td>
		                    	<div class="btn-group">
			                        ...
			                        <ul class="dropdown-menu pull-right">
			                          <li>
			                          		<s:a action="template_input.action">
												<s:param name="tm.uuid" value="uuid"/>
												<i class="icon-edit"></i> 更新
											</s:a>
			                          </li>
			                          <li><a  href="javascript:void(0)" onclick="showMsgDialog(${uuid})"><i class="icon-trash"></i> 删除</a></li>
			                        </ul>
			                      </div>
		                    </td>
		                    <td>
		                    	<button class="btn btn-success" type="button">
		                    		<a  href="template_downloadDoc.action?tm.uuid=${uuid}" style="color:white;" >下载模板</a>
				                </button>
		                    </td>
		                  </tr>
                  </s:iterator>
		...
		<div class="buttons">
             <div class="button">
             	<a href="template_input.action" style="color:white;">添加模板</a>
             </div>
         </div>
		<div class="row">
			<div class="col-md-12">
