...
<div class="page">
	<hr>
    <div class="header">
		<a class="link title-ani"  data-letters="申请文件上载">申请文件上载</a>
        <br>
    </div>
    <hr>
    <div class="form-div">
        <form id="reg-form" action="application_submitApp.action" method="post" enctype="multipart/form-data">
            <s:hidden name="templateUuid"/>
            <section class="step1" style="width:83%;margin:auto;">
            <table>
                <tr>
                    <td colspan="2">
                    	<div class="button filedownload">
		             		<a href="template_downloadDoc.action?tm.uuid=${templateUuid}" style="color:white;">[ 点击下载文档模板文件 ]</a>
		                </div>
                    </td>
                </tr>
            </table>
            <table>
                <tr>
                    <td>
                    <span class="fileinput-button">+ 上传写好申请文档</span>
		...
		<div class="col-md-12">
			<div class="note note-success">
              ...
              <ul>
                <li>下载模板文件。</li>
                <li>填写文档中的表单。</li>
                <li>选择这个填写好的文件进行提交。</li>
                <li>提交表单后，就会按照 模板对应的流程 开始流转。</li>
              </ul>
			</div>
		</div>
	</div>
